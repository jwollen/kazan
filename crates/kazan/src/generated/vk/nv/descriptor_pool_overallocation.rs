//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_NV_descriptor_pool_overallocation.html>
...
pub(super) mod ffi {
    ...
    pub type VkPhysicalDeviceDescriptorPoolOverallocationFeaturesNV =
        PhysicalDeviceDescriptorPoolOverallocationFeaturesNV<'static>;
    impl PhysicalDeviceDescriptorPoolOverallocationFeaturesNV<'_> {
        #[inline]

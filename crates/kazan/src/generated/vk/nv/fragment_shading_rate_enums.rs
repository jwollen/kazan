//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_NV_fragment_shading_rate_enums.html>
...
pub const EXTENSION_NAME: &CStr = c"VK_NV_fragment_shading_rate_enums";

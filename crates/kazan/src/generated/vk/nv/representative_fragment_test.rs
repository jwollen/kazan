//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_NV_representative_fragment_test.html>
...
pub const EXTENSION_NAME: &CStr = c"VK_NV_representative_fragment_test";
...
pub(super) mod defs {
    ...
    #[cfg(feature = "debug")]
    impl fmt::Debug for PhysicalDeviceRepresentativeFragmentTestFeaturesNV<'_> {
    ...
    #[cfg(feature = "debug")]
    impl fmt::Debug for PipelineRepresentativeFragmentTestStateCreateInfoNV<'_> {
        fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {

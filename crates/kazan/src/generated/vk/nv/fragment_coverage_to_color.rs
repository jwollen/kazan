//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_NV_fragment_coverage_to_color.html>
...
pub(super) mod ffi {
    ...
    pub type VkPipelineCoverageToColorStateCreateInfoNV =
        PipelineCoverageToColorStateCreateInfoNV<'static>;
    pub type VkPipelineCoverageToColorStateCreateFlagsNV =
        PipelineCoverageToColorStateCreateFlagsNV;
    impl PipelineCoverageToColorStateCreateInfoNV<'_> {
        #[inline]
        pub unsafe fn drop_lifetime_for_ffi(&self) -> &VkPipelineCoverageToColorStateCreateInfoNV {

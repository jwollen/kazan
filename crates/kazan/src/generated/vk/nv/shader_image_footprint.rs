...
pub(super) mod ffi {
    ...
    pub type VkPhysicalDeviceShaderImageFootprintFeaturesNV =
        PhysicalDeviceShaderImageFootprintFeaturesNV<'static>;
    impl PhysicalDeviceShaderImageFootprintFeaturesNV<'_> {
        #[inline]

//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_NV_extended_sparse_address_space.html>
...
pub const EXTENSION_NAME: &CStr = c"VK_NV_extended_sparse_address_space";

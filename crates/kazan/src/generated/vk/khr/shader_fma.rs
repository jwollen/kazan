//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_KHR_shader_fma.html>
...
pub(super) mod ffi {
    ...
    pub type VkPhysicalDeviceShaderFmaFeaturesKHR = PhysicalDeviceShaderFmaFeaturesKHR<'static>;
    impl PhysicalDeviceShaderFmaFeaturesKHR<'_> {
        #[inline]
        pub unsafe fn drop_lifetime_for_ffi(&self) -> &VkPhysicalDeviceShaderFmaFeaturesKHR {

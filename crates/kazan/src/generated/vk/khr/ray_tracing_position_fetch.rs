//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_KHR_ray_tracing_position_fetch.html>
...
pub(super) mod ffi {
    ...
    pub type VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR =
        PhysicalDeviceRayTracingPositionFetchFeaturesKHR<'static>;
    impl PhysicalDeviceRayTracingPositionFetchFeaturesKHR<'_> {
        #[inline]

//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_KHR_shader_untyped_pointers.html>
...
pub(super) mod defs {
    ...
    unsafe impl Extends<PhysicalDeviceFeatures2<'_>>
        for PhysicalDeviceShaderUntypedPointersFeaturesKHR<'_>
    {
    }
    unsafe impl Extends<DeviceCreateInfo<'_>> for PhysicalDeviceShaderUntypedPointersFeaturesKHR<'_> {}
...
pub(super) mod ffi {
    ...
    pub type VkPhysicalDeviceShaderUntypedPointersFeaturesKHR =
        PhysicalDeviceShaderUntypedPointersFeaturesKHR<'static>;
    impl PhysicalDeviceShaderUntypedPointersFeaturesKHR<'_> {
        #[inline]

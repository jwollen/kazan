...
pub(super) mod ffi {
    ...
    pub type VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR =
        PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR<'static>;
    impl PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR<'_> {
        #[inline]

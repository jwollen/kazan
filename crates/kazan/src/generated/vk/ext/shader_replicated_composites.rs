//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_EXT_shader_replicated_composites.html>
...
pub const EXTENSION_NAME: &CStr = c"VK_EXT_shader_replicated_composites";
...
pub(super) mod ffi {
    ...
    pub type VkPhysicalDeviceShaderReplicatedCompositesFeaturesEXT =
        PhysicalDeviceShaderReplicatedCompositesFeaturesEXT<'static>;
    impl PhysicalDeviceShaderReplicatedCompositesFeaturesEXT<'_> {
        #[inline]

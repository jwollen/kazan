...
pub(super) mod ffi {
    ...
    pub type VkPhysicalDevicePCIBusInfoPropertiesEXT =
        PhysicalDevicePCIBusInfoPropertiesEXT<'static>;
    impl PhysicalDevicePCIBusInfoPropertiesEXT<'_> {
        #[inline]
        pub unsafe fn drop_lifetime_for_ffi(&self) -> &VkPhysicalDevicePCIBusInfoPropertiesEXT {

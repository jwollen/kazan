...
pub(super) mod ffi {
    ...
    pub type VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT =
        PhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT<'static>;
    impl PhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT<'_> {
        #[inline]

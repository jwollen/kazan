//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_EXT_image_compression_control.html>
...
pub(super) mod defs {
    ...
    vk_bitflags_wrapped!(ImageCompressionFlagsEXT, Flags, ImageCompressionFlagBitsEXT);
    ...
    impl fmt::Debug for ImageCompressionFlagsEXT {
        fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
            const KNOWN: &[(Flags, &str)] = &[
                ...
                (ImageCompressionFlagBitsEXT::DISABLED_EXT.0, "DISABLED_EXT"),
            ];

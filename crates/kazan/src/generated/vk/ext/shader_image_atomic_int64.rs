...
pub(super) mod ffi {
    ...
    pub type VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT =
        PhysicalDeviceShaderImageAtomicInt64FeaturesEXT<'static>;
    impl PhysicalDeviceShaderImageAtomicInt64FeaturesEXT<'_> {
        #[inline]

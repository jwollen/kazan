//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_EXT_pipeline_properties.html>
...
pub const EXTENSION_NAME: &CStr = c"VK_EXT_pipeline_properties";
...
pub(super) mod defs {
    ...
    #[cfg(feature = "debug")]
    impl fmt::Debug for PipelinePropertiesIdentifierEXT<'_> {
    ...
    #[cfg(feature = "debug")]
    impl fmt::Debug for PhysicalDevicePipelinePropertiesFeaturesEXT<'_> {
        fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {

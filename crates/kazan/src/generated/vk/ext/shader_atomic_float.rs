//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_EXT_shader_atomic_float.html>
...
pub(super) mod ffi {
    ...
    pub type VkPhysicalDeviceShaderAtomicFloatFeaturesEXT =
        PhysicalDeviceShaderAtomicFloatFeaturesEXT<'static>;
    impl PhysicalDeviceShaderAtomicFloatFeaturesEXT<'_> {
        #[inline]

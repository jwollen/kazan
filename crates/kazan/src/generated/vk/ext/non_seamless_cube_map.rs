//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_EXT_non_seamless_cube_map.html>
...
pub const EXTENSION_NAME: &CStr = c"VK_EXT_non_seamless_cube_map";
...
pub(super) mod ffi {
    ...
    pub type VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT =
        PhysicalDeviceNonSeamlessCubeMapFeaturesEXT<'static>;
    impl PhysicalDeviceNonSeamlessCubeMapFeaturesEXT<'_> {
        #[inline]

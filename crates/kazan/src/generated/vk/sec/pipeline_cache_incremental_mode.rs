...
pub(super) mod defs {
    ...
    unsafe impl Extends<PhysicalDeviceFeatures2<'_>>
        for PhysicalDevicePipelineCacheIncrementalModeFeaturesSEC<'_>
    {
    }
...
pub(super) mod ffi {
    ...
    pub type VkPhysicalDevicePipelineCacheIncrementalModeFeaturesSEC =
        PhysicalDevicePipelineCacheIncrementalModeFeaturesSEC<'static>;
    impl PhysicalDevicePipelineCacheIncrementalModeFeaturesSEC<'_> {
        #[inline]

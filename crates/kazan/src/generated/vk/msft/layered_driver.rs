//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_MSFT_layered_driver.html>
...
pub(super) mod ffi {
    ...
    pub type VkPhysicalDeviceLayeredDriverPropertiesMSFT =
        PhysicalDeviceLayeredDriverPropertiesMSFT<'static>;
    pub type VkLayeredDriverUnderlyingApiMSFT = LayeredDriverUnderlyingApiMSFT;
    impl PhysicalDeviceLayeredDriverPropertiesMSFT<'_> {
        #[inline]
        pub unsafe fn drop_lifetime_for_ffi(&self) -> &VkPhysicalDeviceLayeredDriverPropertiesMSFT {

//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_GGP_stream_descriptor_surface.html>
...
pub const EXTENSION_NAME: &CStr = c"VK_GGP_stream_descriptor_surface";
...
pub(super) mod ffi {
    ...
    pub type VkStreamDescriptorSurfaceCreateInfoGGP = StreamDescriptorSurfaceCreateInfoGGP<'static>;
    pub type VkStreamDescriptorSurfaceCreateFlagsGGP = StreamDescriptorSurfaceCreateFlagsGGP;
    impl StreamDescriptorSurfaceCreateInfoGGP<'_> {
        #[inline]
        pub unsafe fn drop_lifetime_for_ffi(&self) -> &VkStreamDescriptorSurfaceCreateInfoGGP {

...
pub(crate) const EXTENSION_COUNT: usize = 455;
...
pub(crate) fn extension_index(name: &core::ffi::CStr) -> Option<usize> {
    match name.to_bytes() {
        ...
        b"VK_EXT_global_priority" => Some(144),
        b"VK_KHR_shader_subgroup_extended_types" => Some(145),
        b"VK_KHR_8bit_storage" => Some(146),
        b"VK_EXT_external_memory_host" => Some(147),
        b"VK_AMD_buffer_marker" => Some(148),
        b"VK_KHR_shader_atomic_int64" => Some(149),
        b"VK_KHR_shader_clock" => Some(150),
        b"VK_AMD_pipeline_compiler_control" => Some(151),
        b"VK_EXT_calibrated_timestamps" => Some(152),
        b"VK_AMD_shader_core_properties" => Some(153),
        b"VK_KHR_video_decode_h265" => Some(154),
        b"VK_KHR_global_priority" => Some(155),
        b"VK_AMD_memory_overallocation_behavior" => Some(156),
        b"VK_EXT_vertex_attribute_divisor" => Some(157),
        b"VK_GGP_frame_token" => Some(158),
        b"VK_EXT_pipeline_creation_feedback" => Some(159),
        b"VK_KHR_driver_properties" => Some(160),
        b"VK_KHR_shader_float_controls" => Some(161),
        b"VK_NV_shader_subgroup_partitioned" => Some(162),
        b"VK_KHR_depth_stencil_resolve" => Some(163),
        b"VK_KHR_swapchain_mutable_format" => Some(164),
        b"VK_NV_compute_shader_derivatives" => Some(165),
        b"VK_NV_mesh_shader" => Some(166),
        b"VK_NV_fragment_shader_barycentric" => Some(167),
        b"VK_NV_shader_image_footprint" => Some(168),
        b"VK_NV_scissor_exclusive" => Some(169),
        b"VK_NV_device_diagnostic_checkpoints" => Some(170),
        b"VK_KHR_timeline_semaphore" => Some(171),
        b"VK_EXT_present_timing" => Some(172),
        b"VK_INTEL_shader_integer_functions2" => Some(173),
        b"VK_INTEL_performance_query" => Some(174),
        b"VK_KHR_vulkan_memory_model" => Some(175),
        b"VK_EXT_pci_bus_info" => Some(176),
        b"VK_AMD_display_native_hdr" => Some(177),
        b"VK_FUCHSIA_imagepipe_surface" => Some(178),
        b"VK_KHR_shader_terminate_invocation" => Some(179),
        b"VK_EXT_metal_surface" => Some(180),
        b"VK_EXT_fragment_density_map" => Some(181),
        b"VK_EXT_scalar_block_layout" => Some(182),
        b"VK_GOOGLE_hlsl_functionality1" => Some(183),
        b"VK_GOOGLE_decorate_string" => Some(184),
        b"VK_EXT_subgroup_size_control" => Some(185),
        b"VK_KHR_fragment_shading_rate" => Some(186),
        b"VK_AMD_shader_core_properties2" => Some(187),
        b"VK_AMD_device_coherent_memory" => Some(188),
        b"VK_KHR_dynamic_rendering_local_read" => Some(189),
        b"VK_EXT_shader_image_atomic_int64" => Some(190),
        b"VK_KHR_shader_quad_control" => Some(191),
        b"VK_KHR_spirv_1_4" => Some(192),
        b"VK_EXT_memory_budget" => Some(193),
        b"VK_EXT_memory_priority" => Some(194),
        b"VK_KHR_surface_protected_capabilities" => Some(195),
        b"VK_NV_dedicated_allocation_image_aliasing" => Some(196),
        b"VK_KHR_separate_depth_stencil_layouts" => Some(197),
        b"VK_EXT_buffer_device_address" => Some(198),
        b"VK_EXT_tooling_info" => Some(199),
        b"VK_EXT_separate_stencil_usage" => Some(200),
        b"VK_EXT_validation_features" => Some(201),
        b"VK_KHR_present_wait" => Some(202),
        b"VK_NV_cooperative_matrix" => Some(203),
        b"VK_NV_coverage_reduction_mode" => Some(204),
        b"VK_EXT_fragment_shader_interlock" => Some(205),
        b"VK_EXT_ycbcr_image_arrays" => Some(206),
        b"VK_KHR_uniform_buffer_standard_layout" => Some(207),
        b"VK_EXT_provoking_vertex" => Some(208),
        b"VK_EXT_full_screen_exclusive" => Some(209),
        b"VK_EXT_headless_surface" => Some(210),
        b"VK_KHR_buffer_device_address" => Some(211),
        b"VK_EXT_line_rasterization" => Some(212),
        b"VK_EXT_shader_atomic_float" => Some(213),
        b"VK_EXT_host_query_reset" => Some(214),
        b"VK_EXT_index_type_uint8" => Some(215),
        b"VK_EXT_extended_dynamic_state" => Some(216),
        b"VK_KHR_deferred_host_operations" => Some(217),
        b"VK_KHR_pipeline_executable_properties" => Some(218),
        b"VK_EXT_host_image_copy" => Some(219),
        b"VK_KHR_map_memory2" => Some(220),
        b"VK_EXT_map_memory_placed" => Some(221),
        b"VK_EXT_shader_atomic_float2" => Some(222),
        b"VK_EXT_surface_maintenance1" => Some(223),
        b"VK_EXT_swapchain_maintenance1" => Some(224),
        b"VK_EXT_shader_demote_to_helper_invocation" => Some(225),
        b"VK_NV_device_generated_commands" => Some(226),
        b"VK_NV_inherited_viewport_scissor" => Some(227),
        b"VK_KHR_shader_integer_dot_product" => Some(228),
        b"VK_EXT_texel_buffer_alignment" => Some(229),
        b"VK_QCOM_render_pass_transform" => Some(230),
        b"VK_EXT_depth_bias_control" => Some(231),
        b"VK_EXT_device_memory_report" => Some(232),
        b"VK_EXT_acquire_drm_display" => Some(233),
        b"VK_EXT_robustness2" => Some(234),
        b"VK_EXT_custom_border_color" => Some(235),
        b"VK_EXT_texture_compression_astc_3d" => Some(236),
        b"VK_GOOGLE_user_type" => Some(237),
        b"VK_KHR_pipeline_library" => Some(238),
        b"VK_NV_present_barrier" => Some(239),
        b"VK_KHR_shader_non_semantic_info" => Some(240),
        b"VK_KHR_present_id" => Some(241),
        b"VK_EXT_private_data" => Some(242),
        b"VK_EXT_pipeline_creation_cache_control" => Some(243),
        b"VK_KHR_video_encode_queue" => Some(244),
        b"VK_NV_device_diagnostics_config" => Some(245),
        b"VK_QCOM_render_pass_store_ops" => Some(246),
        b"VK_NV_cuda_kernel_launch" => Some(247),
        b"VK_QCOM_tile_shading" => Some(248),
        b"VK_NV_low_latency" => Some(249),
        b"VK_EXT_metal_objects" => Some(250),
        b"VK_KHR_synchronization2" => Some(251),
        b"VK_EXT_descriptor_buffer" => Some(252),
        b"VK_EXT_graphics_pipeline_library" => Some(253),
        b"VK_AMD_shader_early_and_late_fragment_tests" => Some(254),
        b"VK_KHR_fragment_shader_barycentric" => Some(255),
        b"VK_KHR_shader_subgroup_uniform_control_flow" => Some(256),
        b"VK_KHR_zero_initialize_workgroup_memory" => Some(257),
        b"VK_NV_fragment_shading_rate_enums" => Some(258),
        b"VK_NV_ray_tracing_motion_blur" => Some(259),
        b"VK_EXT_mesh_shader" => Some(260),
        b"VK_EXT_ycbcr_2plane_444_formats" => Some(261),
        b"VK_EXT_fragment_density_map2" => Some(262),
        b"VK_QCOM_rotated_copy_commands" => Some(263),
        b"VK_EXT_image_robustness" => Some(264),
        b"VK_KHR_workgroup_memory_explicit_layout" => Some(265),
        b"VK_KHR_copy_commands2" => Some(266),
        b"VK_EXT_image_compression_control" => Some(267),
        b"VK_EXT_attachment_feedback_loop_layout" => Some(268),
        b"VK_EXT_4444_formats" => Some(269),
        b"VK_EXT_device_fault" => Some(270),
        b"VK_ARM_rasterization_order_attachment_access" => Some(271),
        b"VK_EXT_rgba10x6_formats" => Some(272),
        b"VK_NV_acquire_winrt_display" => Some(273),
        b"VK_EXT_directfb_surface" => Some(274),
        b"VK_VALVE_mutable_descriptor_type" => Some(275),
        b"VK_EXT_vertex_input_dynamic_state" => Some(276),
        b"VK_EXT_physical_device_drm" => Some(277),
        b"VK_EXT_device_address_binding_report" => Some(278),
        b"VK_EXT_depth_clip_control" => Some(279),
        b"VK_EXT_primitive_topology_list_restart" => Some(280),
        b"VK_KHR_format_feature_flags2" => Some(281),
        b"VK_EXT_present_mode_fifo_latest_ready" => Some(282),
        b"VK_FUCHSIA_external_memory" => Some(283),
        b"VK_FUCHSIA_external_semaphore" => Some(284),
        b"VK_FUCHSIA_buffer_collection" => Some(285),
        b"VK_HUAWEI_subpass_shading" => Some(286),
        b"VK_HUAWEI_invocation_mask" => Some(287),
        b"VK_NV_external_memory_rdma" => Some(288),
        b"VK_EXT_pipeline_properties" => Some(289),
        b"VK_EXT_frame_boundary" => Some(290),
        b"VK_EXT_multisampled_render_to_single_sampled" => Some(291),
        b"VK_EXT_extended_dynamic_state2" => Some(292),
        b"VK_QNX_screen_surface" => Some(293),
        b"VK_EXT_color_write_enable" => Some(294),
        b"VK_EXT_primitives_generated_query" => Some(295),
        b"VK_KHR_ray_tracing_maintenance1" => Some(296),
        b"VK_KHR_shader_untyped_pointers" => Some(297),
        b"VK_EXT_global_priority_query" => Some(298),
        b"VK_VALVE_video_encode_rgb_conversion" => Some(299),
        b"VK_EXT_image_view_min_lod" => Some(300),
        b"VK_EXT_multi_draw" => Some(301),
        b"VK_EXT_image_2d_view_of_3d" => Some(302),
        b"VK_KHR_portability_enumeration" => Some(303),
        b"VK_EXT_shader_tile_image" => Some(304),
        b"VK_EXT_opacity_micromap" => Some(305),
        b"VK_NV_displacement_micromap" => Some(306),
        b"VK_EXT_load_store_op_none" => Some(307),
        b"VK_HUAWEI_cluster_culling_shader" => Some(308),
        b"VK_EXT_border_color_swizzle" => Some(309),
        b"VK_EXT_pageable_device_local_memory" => Some(310),
        b"VK_KHR_maintenance4" => Some(311),
        b"VK_ARM_shader_core_properties" => Some(312),
        b"VK_KHR_shader_subgroup_rotate" => Some(313),
        b"VK_ARM_scheduling_controls" => Some(314),
        b"VK_EXT_image_sliced_view_of_3d" => Some(315),
        b"VK_VALVE_descriptor_set_host_mapping" => Some(316),
        b"VK_EXT_depth_clamp_zero_one" => Some(317),
        b"VK_EXT_non_seamless_cube_map" => Some(318),
        b"VK_ARM_render_pass_striped" => Some(319),
        b"VK_QCOM_fragment_density_map_offset" => Some(320),
        b"VK_NV_copy_memory_indirect" => Some(321),
        b"VK_NV_memory_decompression" => Some(322),
        b"VK_NV_device_generated_commands_compute" => Some(323),
        b"VK_NV_ray_tracing_linear_swept_spheres" => Some(324),
        b"VK_NV_linear_color_attachment" => Some(325),
        b"VK_GOOGLE_surfaceless_query" => Some(326),
        b"VK_KHR_shader_maximal_reconvergence" => Some(327),
        b"VK_EXT_image_compression_control_swapchain" => Some(328),
        b"VK_QCOM_image_processing" => Some(329),
        b"VK_EXT_nested_command_buffer" => Some(330),
        b"VK_OHOS_external_memory" => Some(331),
        b"VK_EXT_external_memory_acquire_unmodified" => Some(332),
        b"VK_EXT_extended_dynamic_state3" => Some(333),
        b"VK_EXT_subpass_merge_feedback" => Some(334),
        b"VK_LUNARG_direct_driver_loading" => Some(335),
        b"VK_ARM_tensors" => Some(336),
        b"VK_EXT_shader_module_identifier" => Some(337),
        b"VK_EXT_rasterization_order_attachment_access" => Some(338),
        b"VK_NV_optical_flow" => Some(339),
        b"VK_EXT_legacy_dithering" => Some(340),
        b"VK_EXT_pipeline_protected_access" => Some(341),
        b"VK_ANDROID_external_format_resolve" => Some(342),
        b"VK_KHR_maintenance5" => Some(343),
        b"VK_AMD_anti_lag" => Some(344),
        b"VK_AMDX_dense_geometry_format" => Some(345),
        b"VK_KHR_present_id2" => Some(346),
        b"VK_KHR_present_wait2" => Some(347),
        b"VK_KHR_ray_tracing_position_fetch" => Some(348),
        b"VK_EXT_shader_object" => Some(349),
        b"VK_KHR_pipeline_binary" => Some(350),
        b"VK_QCOM_tile_properties" => Some(351),
        b"VK_SEC_amigo_profiling" => Some(352),
        b"VK_KHR_surface_maintenance1" => Some(353),
        b"VK_KHR_swapchain_maintenance1" => Some(354),
        b"VK_QCOM_multiview_per_view_viewports" => Some(355),
        b"VK_NV_ray_tracing_invocation_reorder" => Some(356),
        b"VK_NV_cooperative_vector" => Some(357),
        b"VK_NV_extended_sparse_address_space" => Some(358),
        b"VK_EXT_mutable_descriptor_type" => Some(359),
        b"VK_EXT_legacy_vertex_attributes" => Some(360),
        b"VK_EXT_layer_settings" => Some(361),
        b"VK_ARM_shader_core_builtins" => Some(362),
        b"VK_EXT_pipeline_library_group_handles" => Some(363),
        b"VK_EXT_dynamic_rendering_unused_attachments" => Some(364),
        b"VK_KHR_internally_synchronized_queues" => Some(365),
        b"VK_NV_low_latency2" => Some(366),
        b"VK_KHR_cooperative_matrix" => Some(367),
        b"VK_ARM_data_graph" => Some(368),
        b"VK_QCOM_multiview_per_view_render_areas" => Some(369),
        b"VK_KHR_compute_shader_derivatives" => Some(370),
        b"VK_KHR_video_decode_av1" => Some(371),
        b"VK_KHR_video_encode_av1" => Some(372),
        b"VK_KHR_video_decode_vp9" => Some(373),
        b"VK_KHR_video_maintenance1" => Some(374),
        b"VK_NV_per_stage_descriptor_set" => Some(375),
        b"VK_QCOM_image_processing2" => Some(376),
        b"VK_QCOM_filter_cubic_weights" => Some(377),
        b"VK_QCOM_ycbcr_degamma" => Some(378),
        b"VK_QCOM_filter_cubic_clamp" => Some(379),
        b"VK_EXT_attachment_feedback_loop_dynamic_state" => Some(380),
        b"VK_KHR_vertex_attribute_divisor" => Some(381),
        b"VK_KHR_load_store_op_none" => Some(382),
        b"VK_KHR_unified_image_layouts" => Some(383),
        b"VK_KHR_shader_float_controls2" => Some(384),
        b"VK_QNX_external_memory_screen_buffer" => Some(385),
        b"VK_MSFT_layered_driver" => Some(386),
        b"VK_KHR_index_type_uint8" => Some(387),
        b"VK_KHR_line_rasterization" => Some(388),
        b"VK_KHR_calibrated_timestamps" => Some(389),
        b"VK_KHR_shader_expect_assume" => Some(390),
        b"VK_KHR_maintenance6" => Some(391),
        b"VK_NV_descriptor_pool_overallocation" => Some(392),
        b"VK_QCOM_tile_memory_heap" => Some(393),
        b"VK_KHR_copy_memory_indirect" => Some(394),
        b"VK_EXT_memory_decompression" => Some(395),
        b"VK_NV_display_stereo" => Some(396),
        b"VK_KHR_video_encode_intra_refresh" => Some(397),
        b"VK_KHR_video_encode_quantization_map" => Some(398),
        b"VK_NV_raw_access_chains" => Some(399),
        b"VK_NV_external_compute_queue" => Some(400),
        b"VK_KHR_shader_relaxed_extended_instruction" => Some(401),
        b"VK_NV_command_buffer_inheritance" => Some(402),
        b"VK_KHR_maintenance7" => Some(403),
        b"VK_NV_shader_atomic_float16_vector" => Some(404),
        b"VK_EXT_shader_replicated_composites" => Some(405),
        b"VK_EXT_shader_float8" => Some(406),
        b"VK_NV_ray_tracing_validation" => Some(407),
        b"VK_NV_cluster_acceleration_structure" => Some(408),
        b"VK_NV_partitioned_acceleration_structure" => Some(409),
        b"VK_EXT_device_generated_commands" => Some(410),
        b"VK_KHR_maintenance8" => Some(411),
        b"VK_MESA_image_alignment_control" => Some(412),
        b"VK_KHR_shader_fma" => Some(413),
        b"VK_NV_push_constant_bank" => Some(414),
        b"VK_EXT_ray_tracing_invocation_reorder" => Some(415),
        b"VK_EXT_depth_clamp_control" => Some(416),
        b"VK_KHR_maintenance9" => Some(417),
        b"VK_KHR_video_maintenance2" => Some(418),
        b"VK_OHOS_surface" => Some(419),
        b"VK_HUAWEI_hdr_vivid" => Some(420),
        b"VK_NV_cooperative_matrix2" => Some(421),
        b"VK_ARM_pipeline_opacity_micromap" => Some(422),
        b"VK_EXT_external_memory_metal" => Some(423),
        b"VK_KHR_depth_clamp_zero_one" => Some(424),
        b"VK_ARM_performance_counters_by_region" => Some(425),
        b"VK_EXT_vertex_attribute_robustness" => Some(426),
        b"VK_ARM_format_pack" => Some(427),
        b"VK_VALVE_fragment_density_map_layered" => Some(428),
        b"VK_KHR_robustness2" => Some(429),
        b"VK_NV_present_metering" => Some(430),
        b"VK_EXT_fragment_density_map_offset" => Some(431),
        b"VK_EXT_zero_initialize_device_memory" => Some(432),
        b"VK_KHR_present_mode_fifo_latest_ready" => Some(433),
        b"VK_EXT_shader_64bit_indexing" => Some(434),
        b"VK_EXT_custom_resolve" => Some(435),
        b"VK_QCOM_data_graph_model" => Some(436),
        b"VK_KHR_maintenance10" => Some(437),
        b"VK_EXT_shader_long_vector" => Some(438),
        b"VK_SEC_pipeline_cache_incremental_mode" => Some(439),
        b"VK_EXT_shader_uniform_buffer_unsized_array" => Some(440),
        b"VK_NV_compute_occupancy_priority" => Some(441),
        b"VK_EXT_shader_subgroup_partitioned" => Some(442),
        b"vulkan_video_codecs_common" => Some(443),
        b"vulkan_video_codec_h264std" => Some(444),
        b"vulkan_video_codec_h264std_decode" => Some(445),
        b"vulkan_video_codec_h264std_encode" => Some(446),
        b"vulkan_video_codec_h265std" => Some(447),
        b"vulkan_video_codec_h265std_decode" => Some(448),
        b"vulkan_video_codec_h265std_encode" => Some(449),
        b"vulkan_video_codec_vp9std" => Some(450),
        b"vulkan_video_codec_vp9std_decode" => Some(451),
        b"vulkan_video_codec_av1std" => Some(452),
        b"vulkan_video_codec_av1std_decode" => Some(453),
        b"vulkan_video_codec_av1std_encode" => Some(454),
        _ => None,
    }
}

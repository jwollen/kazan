...
pub(super) mod defs {
    ...
    pub use elapsed_timer_query::defs::*;
    ...
    pub use image_processing3::defs::*;
    ...
    pub use shader_multiple_wait_queues::defs::*;
...
pub(super) mod ffi {
    ...
    pub use super::elapsed_timer_query::ffi::*;
    ...
    pub use super::image_processing3::ffi::*;
    ...
    pub use super::shader_multiple_wait_queues::ffi::*;

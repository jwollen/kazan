//! <https://registry.khronos.org/vulkan/specs/latest/man/html/VK_QCOM_multiview_per_view_viewports.html>
...
pub const EXTENSION_NAME: &CStr = c"VK_QCOM_multiview_per_view_viewports";
...
pub(super) mod defs {
    ...
    #[cfg(feature = "debug")]
    impl fmt::Debug for PhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM<'_> {
        fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
            f.debug_struct("PhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM")
...
pub(super) mod ffi {
    ...
    pub type VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM =
        PhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM<'static>;
    impl PhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM<'_> {
        #[inline]
